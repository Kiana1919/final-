...
def week3():
    def addToList():
        addToList = E1Week3.get()
        print("Adding to list! Great choice!")
        newItem = input("Please type an integer! ")
        myList.append(int(newItem))

#build the results window
        L4Week3 = Label(top, text= "Here's what you added!")
        L4Week3grid(column = 1, row = 2)
        
        L5Week3 = Label(top, text= "{}".format(myRolls))
        L5Week3.grid(column = 1, row = 3)
        
        B2Week3 = Button(text= "week 3", bg="00ff80", command= mainMenu)
        B2Week3.grid(column = 1, row = 4)
